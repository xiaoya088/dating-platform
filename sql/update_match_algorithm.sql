...
ALTER TABLE users ADD COLUMN IF NOT EXISTS property VARCHAR(20);
ALTER TABLE users ADD COLUMN IF NOT EXISTS hukou VARCHAR(100);
ALTER TABLE users ADD COLUMN IF NOT EXISTS current_address VARCHAR(200);
ALTER TABLE users ADD COLUMN IF NOT EXISTS car VARCHAR(20);
