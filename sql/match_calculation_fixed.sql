...
DECLARE
    ...
    v_req_smoking_importance VARCHAR(20) := 'normal';
    v_req_drinking_importance VARCHAR(20) := 'normal';
...
BEGIN
    ...
    SELECT r.min_age, r.max_age, r.min_height, r.max_height,
           ...
           COALESCE(r.smoking_importance, 'normal'), COALESCE(r.drinking_importance, 'normal'),
