...
def main():
    ...
    # 写入文件
    output_path = '/Users/peter/Documents/hongniang/sql/full_init.sql'
    ...
    print("\n使用方法：")
    print("1. 打开 Supabase 控制台: https://supabase.com/dashboard")
    print("2. 选择项目 'xiaoya088'")
    print("3. 点击左侧菜单 'SQL Editor'")
    print("4. 复制此脚本内容粘贴到编辑器")
    print("5. 点击 'Run' 执行")
    print("\n默认账号：")
    print("  - 管理员: admin / admin123")
    print("  - 中介: agency / agency123")
    print("  - 用户1: 13812345678 / 123456")
    print("  - 用户2: 13987654321 / 654321")
